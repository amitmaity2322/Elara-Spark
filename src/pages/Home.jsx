...
import moneyback from '../assets/moneyback-icon.svg';
import Discounts from '../assets/Discounts-icon.svg';
import support from '../assets/support-icon.svg';
import category1_1x from '../assets/category-1(1x).png';
import category1_2x from '../assets/category-1(2x).png';
import category1_3x from '../assets/category-1(3x).png';
import category2_1x from '../assets/category-2(1x).png';
import category2_2x from '../assets/category-2(2x).png';
import category2_3x from '../assets/category-2(3x).png';
import category3_1x from '../assets/category-3(1x).png';
import category3_2x from '../assets/category-3(2x).png';
import category3_3x from '../assets/category-3(3x).png';
import category4_1x from '../assets/category-4(1x).png';
import category4_2x from '../assets/category-4(2x).png';
import category4_3x from '../assets/category-4(3x).png';
import category5_1x from '../assets/category-5(1x).png';
import category5_2x from '../assets/category-5(2x).png';
import category5_3x from '../assets/category-5(3x).png';
import modelbg1x from '../assets/model-bg1x.png';
import modelbg2x from '../assets/model-bg2x.png';
import modelbg3x from '../assets/model-bg3x.png';
import blog1_1x from '../assets/blog-1(1x).jpg'; 
import blog1_2x from '../assets/blog-1(2x).jpg';
import blog1_3x from '../assets/blog-1(3x).jpg';
import blog2_1x from '../assets/blog-2(1x).jpg'; 
import blog2_2x from '../assets/blog-2(2x).jpg';
import blog2_3x from '../assets/blog-2(3x).jpg'; 
import blog3_1x from '../assets/blog-3(1x).jpg'; 
import blog3_2x from '../assets/blog-3(2x).jpg';
import blog3_3x from '../assets/blog-3(3x).jpg';
